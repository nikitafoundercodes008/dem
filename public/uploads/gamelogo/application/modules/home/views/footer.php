<script src="assets\web\js\jquery-2.2.4.min.js"></script>
  <script src="assets\web\js\popper.min.js"></script>
  <script src="assets\web\bootstrap\js\bootstrap.min.js"></script>
  <script src="assets\web\owl-carousel\dist\owl.carousel.min.js"></script>
  ...
  <script>
      $(document).ready(function(){
          ...
          // Toggle chevron-down minus icon on show hide of collapse element
...
<script type="text/javascript">
$('.brand_ambassadors_slider').owlCarousel({
  loop:true,
  margin:10,
  nav:true,
  dots: false,
