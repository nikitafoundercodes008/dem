<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <?php echo anchor(site_url('banners/create'),'Create', 'class="btn btn-primary float-start"'); ?>
          ...
          <div class="table-responsive">
             ...
             foreach ($banners_data as $banner)
            {
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url('uploads/offers/'.$banner->banner_image);?>"
                      style="height: 42px; width: 60px;"> </td>
