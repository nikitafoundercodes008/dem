<div class="content-wrapper">
   ...
   <div class="box box-default">
        ...
        <th>Action</th>
            ...
            <td><img src="<?php echo base_url('uploads/trophy.jpg');?>" style="height: 42px; width: 60px;"></td>
            <td><?php echo anchor(site_url('contest/winning_information/'.$contest->contest_id),'<button style="border-radius: 6px;" type="button" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button>'); ?></td>
